...
public class ResultadoNegativo extends AppCompatActivity {
    int adiccion;
    @Override
    ...
    public void Button_Click(View v) {
        ...
        switch(v.getId()){
            case R.id.denuevo:
                i=new Intent(ResultadoNegativo.this,Diagnostico.class);
                i.putExtra("Adiccion",adiccion);
                startActivity(i);
                break;
            case R.id.noquiero:
                i=new Intent(ResultadoNegativo.this,Seleccion.class);
                i.putExtra("Adiccion",adiccion);
                startActivity(i);
                break;
        }
